...
// Generated on: Dec 29 2024 14:04:36
...
module modular_subtractor(i_start, i_clk, i_rst_n, result, done);
  ...
  wire UNCONNECTED531, cout_2, n_1027, n_1284, n_1285, n_1286, n_1287,
       n_1288;
  ...
  wire n_1537, n_1538, n_1539, sel_R;
  ...
  bmux_6 mux_i_result_56_7(.ctl (sel_R), .in_0 (BKA2_result), .in_1
       (BKA1_result), .z (i_result));
  bmux_6 mux_result_65_11(.ctl (done), .in_0 (result), .in_1
       ...
       n_1285, n_1284}));
  bmux_6 mux_result_63_6(.ctl (n_1027), .in_0 ({n_1539, n_1538, n_1537,
